...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -694675765L;
    ...
    public final EnumPath<umc.spring.study.domain.enums.MissionStatus> status = createEnum("status", umc.spring.study.domain.enums.MissionStatus.class);

    public final umc.spring.study.domain.QStore store;
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new umc.spring.study.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
        this.store = inits.isInitialized("store") ? new umc.spring.study.domain.QStore(forProperty("store"), inits.get("store")) : null;
    }
